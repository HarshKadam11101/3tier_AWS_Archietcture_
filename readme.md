...
*(Add a screenshot of your architecture diagram here. If you don't have one, you can build a quick one in Draw.io or Excalidraw showing the VPC, Public/Private Subnets, ALB, ASG, and RDS).*
